...
@Entity
@Table(name="UnitStockRequestDetail")

public class UnitStockRequestDetail implements Serializable, GEntity {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UnitStockRequestDetail)) {
            return false;
        }
        UnitStockRequestDetail other = (UnitStockRequestDetail) object;
    ...
    public String toString() {
        return "org.rmj.purchasing.pojo.UnitStockRequestDetail[sTransNox=" + sTransNox + "]";
    }
