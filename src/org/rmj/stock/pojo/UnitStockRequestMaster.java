...
@Entity
@Table(name="UnitStockRequestMaster")

public class UnitStockRequestMaster implements Serializable, GEntity {
...
//        this.cConfirmd = 0;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UnitStockRequestMaster)) {
            return false;
        }
        UnitStockRequestMaster other = (UnitStockRequestMaster) object;
    ...
    public String toString() {
        return "org.rmj.stock.pojo.UnitStockRequestMaster[sTransNox=" + sTransNox + "]";
    }
